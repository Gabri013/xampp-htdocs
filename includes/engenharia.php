...
function ensureOrdensProducaoSchema(PDO $db): void
{
    static $done = false;
    if ($done) {
        return;
...
/**
 * Primeira etapa planejada da O.S. (segundo o roteiro da engenharia),
 * na ordem canônica do fluxo. Fallback: corte.
 */
