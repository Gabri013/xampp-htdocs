...
<div class="vend-layout">
    <aside class="vend-sidebar">
        ...
        <div class="vend-nav-group">
            ...
            <a href="index.php" class="vend-nav-item"><i class="fas fa-arrow-down"></i> Contas a Receber</a>
            <a href="contas_pagar.php" class="vend-nav-item active"><i class="fas fa-arrow-up"></i> Contas a Pagar</a>
