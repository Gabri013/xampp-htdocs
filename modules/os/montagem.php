...
<div class="vend-layout">
    <aside class="vend-sidebar">
        <div class="vend-sidebar-logo">
            <div class="vend-logo-icon"><i class="fas fa-tools"></i></div>
